...
//           <motion.div 
//             className="lg:col-span-2 bg-white/10 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-gray-700/30"
...
//           {/* Networking Resources Sidebar */}
//           <motion.div 
//             className="bg-white/10 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-gray-700/30 h-fit"
//             initial={{ opacity: 0, x: 20 }}
//             animate={{ opacity: 1, x: 0 }}
...
//                 {/* Online Communities */}
//                 <div>
//                   <h3 className="text-lg font-bold text-blue-300 mb-3">Online Communities</h3>
...
//                 {/* Conferences */}
//                 <div>
//                   <h3 className="text-lg font-bold text-purple-300 mb-3">Conferences</h3>
//                   <div className="space-y-3">
...
//                 {/* Mentorship */}
//                 <div>
//                   <h3 className="text-lg font-bold text-blue-300 mb-3">Mentorship Programs</h3>
//                   <div className="space-y-3">
